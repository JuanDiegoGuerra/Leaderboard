...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n/* harmony import */ var _modules_fetchingApi_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/fetchingApi.js */ \"./src/modules/fetchingApi.js\");\n/* harmony import */ var _modules_renderApiData_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/renderApiData.js */ \"./src/modules/renderApiData.js\");\n\r\n\r\n\r\n\r\n\r\nconst reloadBtn = document.getElementById('refresh-btn');\r\nconst form = document.getElementById('add-form');\r\nconst nameToAdd = document.getElementById('name');\r\nconst scoreToAdd = document.getElementById('score');\r\n\r\nconst renderListOnload = async () => {\r\n  const scoresData = await (0,_modules_fetchingApi_js__WEBPACK_IMPORTED_MODULE_1__.getScores)();\r\n  (0,_modules_renderApiData_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(scoresData);\r\n};\r\n\r\nwindow.onload = renderListOnload();\r\n\r\nreloadBtn.addEventListener('click', async () => {\r\n  const scoresData = await (0,_modules_fetchingApi_js__WEBPACK_IMPORTED_MODULE_1__.getScores)();\r\n  (0,_modules_renderApiData_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(scoresData);\r\n});\r\n\r\nform.addEventListener('submit', async (e) => {\r\n  e.preventDefault();\r\n  await (0,_modules_fetchingApi_js__WEBPACK_IMPORTED_MODULE_1__.addScore)(nameToAdd.value, scoreToAdd.valueAsNumber);\r\n  const scoresData = await (0,_modules_fetchingApi_js__WEBPACK_IMPORTED_MODULE_1__.getScores)();\r\n  (0,_modules_renderApiData_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(scoresData);\r\n  nameToAdd.value = '';\r\n  scoreToAdd.value = '';\r\n});\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");

/***/ }),

/***/ "./src/modules/fetchingApi.js":
/*!************************************!*\
  !*** ./src/modules/fetchingApi.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   addScore: () => (/* binding */ addScore),\n/* harmony export */   getScores: () => (/* binding */ getScores)\n/* harmony export */ });\nconst apiUrl = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/lyyHMBWzgAOEuOOl3eGh/scores/';\r\n\r\nconst getScores = async () => {\r\n  const response = await fetch(apiUrl);\r\n  const jsonData = await response.json();\r\n  return jsonData.result;\r\n};\r\n\r\nconst addScore = async (user, score) => {\r\n  const newScore = {\r\n    user,\r\n    score,\r\n  };\r\n  const response = await fetch(apiUrl, {\r\n    method: 'POST',\r\n    headers: {\r\n      'Content-Type': 'application/json',\r\n    },\r\n    body: JSON.stringify(newScore),\r\n  });\r\n  const jsonData = await response.json();\r\n  return jsonData.result;\r\n};\n\n//# sourceURL=webpack://leaderboard/./src/modules/fetchingApi.js?");

/***/ }),

/***/ "./src/modules/renderApiData.js":
/*!**************************************!*\
  !*** ./src/modules/renderApiData.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst scores = document.getElementById('scores');\r\n\r\nconst renderscores = (scoreList) => {\r\n  let renderText = '';\r\n  let poss;\r\n  scoreList.forEach((score, idx) => {\r\n    poss = '';\r\n    if (idx % 2 === 0) {\r\n      poss = 'poss-row';\r\n    }\r\n    renderText += `\r\n        <div class=\"scores-row ${poss}\">\r\n          <p class=\"row-description\">${score.user}: ${score.score}</p>\r\n        </div>\r\n        `;\r\n  });\r\n  scores.innerHTML = renderText;\r\n};\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (renderscores);\n\n//# sourceURL=webpack://leaderboard/./src/modules/renderApiData.js?");
